...
export { IMessage, IMessageAction, IOrganizationEntity, ISubscriberJwt, IPreferenceChannels, IMessageCTA, IActor, ActorTypeEnum, IMessageButton, } from '@novu/shared';
export declare enum ScreensEnum {
...
export type ListItem = (message: IMessage, onActionButtonClick: (actionButtonType: ButtonTypeEnum) => void, onNotificationClick: () => void) => JSX.Element;
...
export interface INotificationsContext extends IStoreContext {
    ...
    refetch: <TPageData>({ page, ...otherOptions }?: {
        page?: number;
    } & RefetchOptions & RefetchQueryFilters<TPageData>) => void;
